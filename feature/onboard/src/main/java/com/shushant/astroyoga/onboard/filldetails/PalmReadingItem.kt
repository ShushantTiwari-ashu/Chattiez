...
fun PalmReadingItem(
    ...
    Box(modifier = Modifier) {
        Column(
            ...
            Image(
                painter = painterResource(id = AppResource.PALM_READING.drawable),
                contentDescription = "",
            ...
            Text(
                text = userState.userName + stringResource(R.string.palm_scan),
                color = Color.Black,
            ...
            Text(
                text = stringResource(R.string.follow_palm),
                color = Color.Gray,
                style = Typography.bodyLarge.copy(
        ...
        ChattiezButton(
            buttonText = stringResource(R.string.scan_pam),
